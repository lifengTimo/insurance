...
* @Description: TODO(药品拿药天数限制Dao) 
* @author lifeng
* @date 2018年5月11日 下午12:03:34 
*
 */
public interface DrugDayRepository  extends JpaRepository<DrugDay,Integer>{
	...
	* @throws
	...
	@Transactional
	@Modifying
	@Query(value="delete from insurance_drug_day  where id in ?1",nativeQuery=true)
